#!/usr/bin/env bash
# Usage: ./_generate-image.sh "A robotic arm assembling a circuit board" "output-filename"
# Generates a blog cover image via OpenAI GPT-Image-2 and saves as blog/posts/img/<filename>.webp
